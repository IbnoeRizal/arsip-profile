...
export function filterQuery(request,tableName) {
    ...
    for(const key in refer){
        ...
        //if condition above is failed, then it is either cuid or parameter doesn't exist and must be replaced with undefined
        refer[key] = parameter ?? undefined;
    }
